...
const CustomizeTab: React.FC<CustomizeTabProps> = ({ posterUrl, backdropUrl, onOpenImageSelector }) => {
  return (
            ...
            <div>
                ...
                <div className="relative group">
                    ...
                    <button 
                        ...
                        className="absolute inset-0 bg-black/60 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity rounded-lg cursor-pointer"
                    >
