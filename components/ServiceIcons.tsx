...
export const TraktIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" fill="currentColor" {...props}>
        <path d="M43.76,4.24a4.4,4.4,0,0,0-6.23,0L25,16.77,12.47,4.24a4.4,4.4,0,0,0-6.23,0,4.4,4.4,0,0,0,0,6.23L18.77,23,6.24,35.53a4.4,4.4,0,0,0,0,6.23,4.4,4.4,0,0,0,6.23,0L25,29.23,37.53,41.76a4.4,4.4,0,0,0,6.23,0,4.4,4.4,0,0,0,0-6.23L31.23,23,43.76,10.47A4.4,4.4,0,0,0,43.76,4.24Z"/>
    </svg>
);
