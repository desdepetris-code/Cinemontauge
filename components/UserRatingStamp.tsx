...
const UserRatingStamp: React.FC<UserRatingStampProps> = ({ rating, size = 'sm', className = '' }) => {
    ...
    return (
        <div className={`flex flex-col items-center justify-center bg-gradient-to-br from-yellow-300 via-yellow-500 to-amber-700 text-black font-black uppercase rounded-lg shadow-[0_4px_12px_rgba(0,0,0,0.6)] border border-yellow-200/50 z-20 group-hover:scale-110 transition-transform duration-300 ${sizeClasses[size]} ${className}`}>
